...
```bash
# Override via CLI
./nanowm python src/main.py experiment=ablation_rt1 dataset=rt1/rt1 model=nanowm_b2 \
...
```bash
./nanowm python src/main.py experiment=ablation_rt1 dataset=rt1/rt1 model=nanowm_l2
```
